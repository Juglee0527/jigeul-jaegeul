...
export class Hud {
  ...
  constructor(scene: Phaser.Scene) {
    ...
    scene.add.rectangle(40, 50, 240, 12, 0x2c1c32, 1)
      .setOrigin(0, 0.5)
      .setDepth(HUD_DEPTH + 1);
    this.hpBar = scene.add.rectangle(40, 50, 240, 12, COLORS.primary, 1)
      .setOrigin(0, 0.5)
      .setDepth(HUD_DEPTH + 2);
    this.hpText = scene.add.text(290, 42, '', {
      ...labelStyle,
      color: '#f9ecff',
      fontSize: '15px',
    }).setDepth(HUD_DEPTH + 1);
    ...
    this.killText = scene.add.text(GAME_WIDTH - 318, 21, '', labelStyle)
      .setOrigin(1, 0)
      .setDepth(HUD_DEPTH + 1);
    ...
    const wavePanel = scene.add.rectangle(GAME_WIDTH / 2, GAME_HEIGHT - 28, 360, 38, 0x0d0913, 0.88)
      .setStrokeStyle(1, COLORS.secondary, 0.6)
      .setDepth(HUD_DEPTH);
